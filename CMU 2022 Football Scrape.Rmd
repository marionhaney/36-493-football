...
Get the main URL of all games during WK and season YEAR:
```{r}
...
Get links to play by play lines:
```{r}
...
Function to gather all 14 weeks of data
```{r}
...
URLS = c("https://www.d3football.com/scoreboard/2022/composite?view=1", 
        ...
        "https://www.d3football.com/scoreboard/2022/composite?view=11",
        "https://www.d3football.com/scoreboard/2022/composite?view=12", 
        "https://www.d3football.com/scoreboard/2022/composite?view=13")
```
