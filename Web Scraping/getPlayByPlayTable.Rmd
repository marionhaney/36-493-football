...
wantedTeams: a vector of strings of the full names of each team to scrape for
OUTPUT: a table from the play by play link for each team in wantedTeams
DEFAULT: wantedTeams = c("Carnegie Mellon")


```{r}
getPlayByPlayTable = function(links, wantedTeams = c("Carnegie Mellon")) {
  bigBadTable = NULL
...
getPlayByPlayTable(links, wantedTeams = c("Carnegie Mellon"))
```
