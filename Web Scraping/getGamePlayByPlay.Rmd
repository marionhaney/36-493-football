  ...
  tryCatch(
    {
      ...
      for (i in 1:nrow(game)) {
        ...
        if (nchar(situation) >= 25 && startsWith %in% downs) {
          ...
          # get play
          currentPlay = str_extract(play, "(rush|pass|PENALTY|fumble|sacked|punt|field goal|kick|Kneel|clock)")
