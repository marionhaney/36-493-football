...
data %>%
  ...
  ggplot(aes(x = Distance.to.Touchdown, y = value, color = name)) +
  geom_smooth() +
  scale_x_reverse() +
  labs(title = "Probability of Scoring Outcome", x = "Distance to Opponent's Touchdown",
       y = "Probability of Outcome Occuring", color = "Scoring Outcome") +
  scale_color_hue(labels = c('Field Goal Percentage', 'Touchdown Percentage')) +
