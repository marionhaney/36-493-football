...
url = "https://www.d3football.com/scoreboard/2022/composite?view=4"
  ...
  for (i in 1:nrow(game)) {
    ...
    if (nchar(situation) >= 25 && startsWith %in% downs) {
      ...
      if (!(is.na(str_extract(play,
                  "(kickoff|hurry|ball|drive|quarter|half|Timeout|game|toss|QB|receive|defers|defend|clock|Clock)")))) {
        # has no wanted information, so skip
        next
      }
      ...
      if (is.na(currentPossession)) {print(currentPossession)}
