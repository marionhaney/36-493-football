...
url = "https://www.d3football.com/scoreboard/2022/composite?view=3"
...
gamePlayByPlay = function(game, date, time, location, homeTeam, homeAbb, awayTeam, awayAbb) {
  ...
  for (i in 1:nrow(game)) {
    ...
    if (str_detect(play, "[0-1]*[0-9]:[0-5][0-9]")) {
      # has no wanted information, so skip
      next
    }
    ...
    if (nchar(situation) >= 25 && startsWith %in% downs) {
      ...
      if ((is.logical(currentPossession) && length(currentPossession) == 1 && 
           !is.na(currentPossession) && currentPossession)) {
        print(currentPossession)}
      ...
      # get play
      currentPlay = str_extract(play, "(rush|pass|Pass|PENALTY|fumble|sacked|punt|field goal|kick|Kneel|caught|Penalty)")
