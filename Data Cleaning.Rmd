...
init.data[init.data$TD.score == T & init.data$odk == "O", "next.score"] = "TD For"
init.data[init.data$TD.score == T & init.data$odk == "D", "next.score"] = "TD Against"

init.data[init.data$FG.score == T & 
            !is.na(init.data$play.type) & 
            init.data$play.type == "FG", "next.score"] = "FG For"
init.data[init.data$FG.score == T & init.data$play.type == "FG Block", "next.score"] = "FG Against"
