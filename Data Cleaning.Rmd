...
init.data = init.data.full[-rem.rows, ] #DROP KOs, Extra Pts, 2 Pt comnversions, Penalties, and Timeouts
...
init.data[1442, "play.type"] = "Extra Pt."
init.data[1556, "play.type"] = "Extra Pt."
init.data[1975, "play.type"] = "Extra Pt."
init.data[1994, "play.type"] = "Extra Pt."
